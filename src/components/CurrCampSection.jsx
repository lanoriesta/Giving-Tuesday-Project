...
const CurrCampSection = () => {
  return (
    <div className="px-5 py-10 bg-white lg:px-20 xl:px-40 2xl:px-100 md:flex flex-col items-center justify-center">
      ...
      <div className="py-10">
        ...
        <div className="grid  grid-rows md:grid-cols-3 md:items-stretch items-center gap-8">
          <div className="grid grid-cols-4 md:block gap-3 items-center">
            ...
            <div className="col-span-3">
              ...
              <p className="opacity-70">
                Share that you're joining Giving Tuesday, how you're planning to
                give back, or a cause/non-profit you're supporting.
              </p>
            </div>
          </div>
          <div className="grid grid-cols-4 md:block gap-3 items-center">
            ...
            <div className="col-span-3">
              ...
              <p className="opacity-70">
                Add the hashtag #givingtuesday and #givingtuesdayph to caption.
              </p>
            </div>
          </div>
          <div className="grid grid-cols-4 md:block gap-3 items-center">
